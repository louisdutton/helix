...
bitflags! {
    ...
    ///
    /// ```rust
    /// # use fugue_view::graphics::Modifier;
    ///
...
///
/// ```rust
/// # use fugue_view::graphics::{Rect, Color, UnderlineStyle, Modifier, Style};
/// # use fugue_tui::buffer::Buffer;
/// let styles = [
...
impl Style {
    ...
    ///
    /// ```rust
    /// # use fugue_view::graphics::{Color, Style};
    ...
    ///
    /// ```rust
    /// # use fugue_view::graphics::{UnderlineStyle, Style};
