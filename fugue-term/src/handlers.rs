...
pub use fugue_view::handlers::{word_index, Handlers};
...
pub fn setup(config: Arc<ArcSwap<Config>>) -> Handlers {
    ...
    let handlers = Handlers {
        completions: fugue_view::handlers::completion::CompletionHandler::new(event_tx),
        signature_hints,
        auto_save,
        document_colors,
        word_index,
    ...
    fugue_view::handlers::register_hooks(&handlers);
