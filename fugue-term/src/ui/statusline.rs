...
use fugue_view::document::DEFAULT_LANGUAGE_NAME;
use fugue_view::{
...
use fugue_view::editor::StatusLineElement as StatusLineElementID;
...
{
    match element_id {
        fugue_view::editor::StatusLineElement::Mode => render_mode,
        fugue_view::editor::StatusLineElement::Spinner => render_lsp_spinner,
        fugue_view::editor::StatusLineElement::FileBaseName => render_file_base_name,
        fugue_view::editor::StatusLineElement::FileName => render_file_name,
        fugue_view::editor::StatusLineElement::FileAbsolutePath => render_file_absolute_path,
        fugue_view::editor::StatusLineElement::FileModificationIndicator => {
            render_file_modification_indicator
        }
        fugue_view::editor::StatusLineElement::ReadOnlyIndicator => render_read_only_indicator,
        fugue_view::editor::StatusLineElement::FileEncoding => render_file_encoding,
        fugue_view::editor::StatusLineElement::FileLineEnding => render_file_line_ending,
        fugue_view::editor::StatusLineElement::FileIndentStyle => render_file_indent_style,
        fugue_view::editor::StatusLineElement::FileType => render_file_type,
        fugue_view::editor::StatusLineElement::Diagnostics => render_diagnostics,
        fugue_view::editor::StatusLineElement::WorkspaceDiagnostics => render_workspace_diagnostics,
        fugue_view::editor::StatusLineElement::Selections => render_selections,
        fugue_view::editor::StatusLineElement::PrimarySelectionLength => {
            render_primary_selection_length
        }
        fugue_view::editor::StatusLineElement::Position => render_position,
        fugue_view::editor::StatusLineElement::PositionPercentage => render_position_percentage,
        fugue_view::editor::StatusLineElement::TotalLineNumbers => render_total_line_numbers,
        fugue_view::editor::StatusLineElement::Separator => render_separator,
        fugue_view::editor::StatusLineElement::Spacer => render_spacer,
        fugue_view::editor::StatusLineElement::VersionControl => render_version_control,
        fugue_view::editor::StatusLineElement::Register => render_register,
        fugue_view::editor::StatusLineElement::CurrentWorkingDirectory => render_cwd,
    }
}
...
where
    F: Fn(&mut RenderContext<'a>, Span<'a>) + Copy,
{
    let cwd = fugue_stdx::env::current_working_dir();
    let cwd = cwd
        .file_name()
        .unwrap_or_default()
        .to_string_lossy()
