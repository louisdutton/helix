...
impl<T: Component> Popup<T> {
    ...
    fn render_info(&mut self, viewport: Rect, editor: &Editor) -> RenderInfo {
        ...
        let is_menu = self
            .contents
            .type_name()
            .starts_with("fugue_term::ui::menu::Menu");
            ...
            if !fits {
                ...
                for i in 0..win_height {
                    ...
                    if scroll_line <= i && i < scroll_line + scroll_height {
                        ...
                        cell.set_fg(scroll_style.fg.unwrap_or(fugue_view::theme::Color::Reset));
                    } else if !render_borders {
                        // Draw scroll track
                        cell.set_symbol(half_block);
                        cell.set_fg(scroll_style.bg.unwrap_or(fugue_view::theme::Color::Reset));
                    }
                }
            }
        }
