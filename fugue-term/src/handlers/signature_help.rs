...
use fugue_event::{cancelable_future, register_hook, send_blocking, TaskController, TaskHandle};
use fugue_lsp::lsp::{self, SignatureInformation};
use fugue_stdx::rope::RopeSliceExt;
use fugue_view::document::Mode;
use fugue_view::events::{DocumentDidChange, SelectionDidChange};
use fugue_view::handlers::lsp::{SignatureHelpEvent, SignatureHelpInvoked};
...
impl fugue_event::AsyncHook for SignatureHelpHandler {
...
fn active_param_range(
    ...
    match &param.label {
        ...
        lsp::ParameterLabel::LabelOffsets([start, end]) => {
            ...
            // but highlighting in fugue is done using byte offset.
            use fugue_core::str_utils::char_to_byte_idx;
...
pub fn show_signature_help(
    ...
    // annoyance, see https://github.com/fugue-editor/fugue/issues/3112
