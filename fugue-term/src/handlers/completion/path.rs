...
use fugue_core::{self as core, completion::CompletionProvider, Selection, Transaction};
use fugue_event::TaskHandle;
use fugue_stdx::path::{self, canonicalize, fold_home_dir, get_path_suffix};
use fugue_view::{document::SavePoint, handlers::completion::ResponseContext, Document};
use url::Url;
