...
use fugue_core::completion::CompletionProvider;
use fugue_core::syntax::config::LanguageServerFeature;
use fugue_event::{cancelable_future, TaskController, TaskHandle};
use fugue_lsp::lsp;
use fugue_lsp::lsp::{CompletionContext, CompletionTriggerKind};
use fugue_lsp::util::pos_to_lsp_pos;
use fugue_stdx::rope::RopeSliceExt;
use fugue_view::document::{Mode, SavePoint};
use fugue_view::handlers::completion::{CompletionEvent, ResponseContext};
use fugue_view::{Document, DocumentId, Editor, ViewId};
...
impl fugue_event::AsyncHook for CompletionHandler {
