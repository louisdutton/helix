...
macro_rules! key {
    ($key:ident) => {
        ::fugue_view::input::KeyEvent {
            code: ::fugue_view::keyboard::KeyCode::$key,
            modifiers: ::fugue_view::keyboard::KeyModifiers::NONE,
        }
    };
    ($($ch:tt)*) => {
        ::fugue_view::input::KeyEvent {
            code: ::fugue_view::keyboard::KeyCode::Char($($ch)*),
            modifiers: ::fugue_view::keyboard::KeyModifiers::NONE,
        }
    };
}
...
macro_rules! shift {
    ($key:ident) => {
        ::fugue_view::input::KeyEvent {
            code: ::fugue_view::keyboard::KeyCode::$key,
            modifiers: ::fugue_view::keyboard::KeyModifiers::SHIFT,
        }
    };
    ($($ch:tt)*) => {
        ::fugue_view::input::KeyEvent {
...
macro_rules! ctrl {
    ($key:ident) => {
        ::fugue_view::input::KeyEvent {
            code: ::fugue_view::keyboard::KeyCode::$key,
            modifiers: ::fugue_view::keyboard::KeyModifiers::CONTROL,
        }
    };
    ($($ch:tt)*) => {
        ::fugue_view::input::KeyEvent {
...
macro_rules! alt {
    ($key:ident) => {
        ::fugue_view::input::KeyEvent {
            code: ::fugue_view::keyboard::KeyCode::$key,
            modifiers: ::fugue_view::keyboard::KeyModifiers::ALT,
        }
    };
    ($($ch:tt)*) => {
        ::fugue_view::input::KeyEvent {
...
macro_rules! keymap {
    ...
    (
        ...
        // modified from the hashmap! macro
        {
            ...
            $(
                $(
                    let _key = $key.parse::<::fugue_view::input::KeyEvent>().unwrap();
