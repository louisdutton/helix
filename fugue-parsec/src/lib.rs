...
///
/// ```
/// use fugue_parsec::{take_until, Parser};
...
///
/// ```
/// use fugue_parsec::{take_while, Parser};
...
///
/// ```
/// use fugue_parsec::{choice, or, Parser};
...
///
/// ```
/// use fugue_parsec::{filter_map, take_until, Parser};
...
///
/// ```
/// use fugue_parsec::{reparse_as, take_until, one_or_more, Parser};
...
///
/// ```
/// use fugue_parsec::{filter, take_until, Parser};
...
///
/// ```
/// use fugue_parsec::{optional, Parser};
...
///
/// ```
/// use fugue_parsec::{zero_or_more, Parser};
...
///
/// ```
/// use fugue_parsec::{one_or_more, Parser};
