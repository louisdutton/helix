...
use fugue_loader::grammar::get_language;
use fugue_stdx::rope::RopeSliceExt as _;
...
pub fn read_query(lang: &str, query_filename: &str) -> String {
    tree_house::read_query(lang, |language| {
        fugue_loader::grammar::load_runtime_file(language, query_filename).unwrap_or_default()
    })
}
