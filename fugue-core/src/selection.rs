...
use fugue_stdx::range::is_subset;
use fugue_stdx::rope::{self, RopeSliceExt};
...
impl From<Range> for fugue_stdx::Range {
...
impl Selection {
    ...
    pub fn range_bounds(&self) -> impl Iterator<Item = fugue_stdx::Range> + '_ {
