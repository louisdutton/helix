...
#[test]
fn test_treesitter_indent_rust_fugue() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "fugue-term/src/application.rs" => vec![
            ...
            "fugue-term/src/commands.rs" => vec![
            ...
            "fugue-term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "fugue-term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `fugue-term/src/commands.rs`
                1335..1343,
            ],
            "fugue-term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "fugue-term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "fugue-term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "fugue-term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "fugue-term/src/ui/editor.rs" => vec![
            ...
            "fugue-term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "fugue-term/src/ui/statusline.rs" => vec![
                // Same as in `fugue-term/src/commands.rs`
                436..442,
                450..456,
            ],
...
fn test_treesitter_indent(
    ...
    std::env::set_var("FUGUE_RUNTIME", runtime.to_str().unwrap());
