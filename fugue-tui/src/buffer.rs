...
use fugue_view::graphics::{Color, Modifier, Rect, Style, UnderlineStyle};
...
///
/// ```
/// use fugue_tui::buffer::{Buffer, Cell};
/// use fugue_view::graphics::{Rect, Color, UnderlineStyle, Style, Modifier};
///
