...
use fugue_view::graphics::{Rect, Style};

/// A [`Cell`] contains the [`Text`] to be displayed in a [`Row`] of a [`Table`].
///
/// It can be created from anything that can be converted to a [`Text`].
/// ```rust
/// # use fugue_tui::widgets::Cell;
/// # use fugue_tui::text::{Span, Spans, Text};
/// # use fugue_view::graphics::{Style, Modifier};
...
/// ```rust
/// # use fugue_tui::widgets::{Block, Borders, Table, Row, Cell};
/// # use fugue_tui::layout::Constraint;
/// # use fugue_view::graphics::{Style, Color, Modifier};
/// # use fugue_tui::text::{Text, Spans, Span};
/// Table::new(vec![
